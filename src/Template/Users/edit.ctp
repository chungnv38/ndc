<div class="container-fluid">
    <h3 class="page-title text-black">Administration Of Users - Edit User</h3>
    <div class="row">
        <?php echo $this->Form->create(null,array('url'=>array('controller' => 'Users','action' => 'edit/'.$user['id'])));?>
