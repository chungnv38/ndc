...
<div class="container-fluid">
    ...
    <div class="row">
        <?php echo $this->Form->create(null,array('url'=>array('controller' => 'Users','action' => 'statistic')));?>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="user" class="form-control input-sm">
                                ...
                                $user = ($user)?$user:null;
                                foreach ($users as $v){
                                    if($v['user_login_name'] == $user) $selected = 'selected';
                                    else $selected = '';
                                    echo "<option $selected value='".$v['user_login_name']."'>".$v['user_login_name']."</option>";
                                }
                                ?>
                            </select>
                        </td>
