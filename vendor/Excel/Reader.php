...
/**
 * Main Class: Vlib_Excel_Reader  is alias of Spreadsheet_Excel_Reader
 * @copyright Tran Nghia <nghiat@vnext.vn>
 * 
*/
class Vlib_Excel_Reader {
	 ...
	 */
	function Vlib_Excel_Reader($file='',$store_extended_info=true,$outputEncoding='') {
